...
<head>
  ...
  <link href="mobilelegends.css" rel="stylesheet">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="../mobilelegends/mobilelegends.php">Mobile Legends</a></li>
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <img src="../assets/img/icon/Layer.png"><br><br>
          <h1>Mobile Legends</h1>
        </div>
        <form method="POST" action="cekmobilelegends.php">
        <div class="icon-text">
        ...
        <div class="row icon-boxes">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 pilihan" data-aos="fade-down" data-aos-delay="100">
            <input type="radio" name="qty" id="100" value="100 Diamonds" required>
            <label for="100"><center><strong>100 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 10.000</center></label>
            <input type="radio" name="qty" id="250" value="250 Diamonds" required>
            <label for="250"><center><strong>250 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 25.000</center></label>
            <input type="radio" name="qty" id="500" value="500 Diamonds" required>
            <label for="500"><center><strong>500 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 50.000</center></label>
            <input type="radio" name="qty" id="1000" value="1000 Diamonds" required>
            <label for="1000"><center><strong>1000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 100.000</center></label>
            <input type="radio" name="qty" id="2000" value="2000 Diamonds" required>
            <label for="2000"><center><strong>2000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 200.000</center></label>
            <input type="radio" name="qty" id="4000" value="4000 Diamonds" required>
            <label for="4000"><center><strong>4000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 400.000</center></label>
          </div>
        </div>
        ...
        <div class="button" data-aos="fade-right" data-aos-delay="100">
          <input type="submit" value="Order Sekarang" class="tombol" name="mobilelegends">
        </div>
        </form>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form method="POST" action="cekmobilelegends.php">
              <input type="text" name="saran"><input type="submit" value="Kirim" name="mobilelegends2">
            </form>
          </div>
