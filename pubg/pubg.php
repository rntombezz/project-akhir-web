    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="../pubg/pubg.php">PUBG Mobile</a></li>
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <img src="../assets/img/icon/pubg.png"><br><br>
          <h1>PUBG Mobile</h1>
        </div>
        <form method="POST" action="cekpubg.php">
        <div class="icon-text">
        ...
        <div class="row icon-boxes">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 pilihan" data-aos="fade-down" data-aos-delay="100">
            <input type="radio" name="qty" id="1" value="150 UC" required>
            <label for="1"><center><strong>150 UC <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 10.000</center></label>
            <input type="radio" name="qty" id="2" value="350 UC" required>
            <label for="2"><center><strong>350 UC <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 25.000</center></label>
            <input type="radio" name="qty" id="3" value="750 UC" required>
            <label for="3"><center><strong>750 UC <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 50.000</center></label>
            <input type="radio" name="qty" id="4" value="1500 UC" required>
            <label for="4"><center><strong>1500 UC <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 100.000</center></label>
            <input type="radio" name="qty" id="5" value="3000 UC" required>
            <label for="5"><center><strong>3000 UC <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 200.000</center></label>
            <input type="radio" name="qty" id="6" value="6000 UC" required>
            <label for="6"><center><strong>6000 UC <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 400.000</center></label>
          </div>
        </div>
        ...
        <div class="button" data-aos="fade-right" data-aos-delay="100">
          <input type="submit" value="Order Sekarang" class="tombol" name="pubg">
        </div>
        </form>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form method="POST" action="cekpubg.php">
              <input type="text" name="saran"><input type="submit" value="Kirim" name="pubg2">
            </form>
          </div>
