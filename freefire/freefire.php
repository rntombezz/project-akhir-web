    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <img src="../assets/img/icon/freefire.png"><br><br>
          <h1>Free Fire</h1>
        </div>
        <form method="POST" action="cekfreefire.php">
        <div class="icon-text">
        ...
        <div class="row icon-boxes">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 pilihan" data-aos="fade-down" data-aos-delay="100">
            <input type="radio" name="qty" id="1" value="250 Diamonds" required>
            <label for="1"><center><strong>250 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 10.000</center></label>
            <input type="radio" name="qty" id="2" value="500 Diamonds" required>
            <label for="2"><center><strong>500 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 25.000</center></label>
            <input type="radio" name="qty" id="3" value="1000 Diamonds" required>
            <label for="3"><center><strong>1000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 50.000</center></label>
            <input type="radio" name="qty" id="4" value="2000 Diamonds" required>
            <label for="4"><center><strong>2000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 100.000</center></label>
            <input type="radio" name="qty" id="5" value="4000 Diamonds" required>
            <label for="5"><center><strong>4000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 200.000</center></label>
            <input type="radio" name="qty" id="6" value="8000 Diamonds" required>
            <label for="6"><center><strong>8000 Diamonds <h6>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</h6></strong>Rp 400.000</center></label>
          </div>
        </div>
        ...
        <div class="button" data-aos="fade-right" data-aos-delay="100">
          <input type="submit" value="Order Sekarang" class="tombol" name="freefire">
        </div>
        </form>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form method="POST" action="cekfreefire.php">
              <input type="text" name="saran"><input type="submit" value="Kirim" name="freefire2">
            </form>
          </div>
