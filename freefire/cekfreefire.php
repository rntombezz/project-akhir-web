...
include "../config.php";
    ...
    if(@$_SESSION['status']) {
        if(isset($_POST['freefire'])){
            ...
            $via = $_POST['bayar'];
            $tlp = $_POST['telepon'];
                if ($_POST['qty'] == '250 Diamonds') {
                    $harga = 'Rp 10.000';
                } else if ($_POST['qty'] == '500 Diamonds') {
                    $harga = 'Rp 25.000';
                } else if ($_POST['qty'] == '100 Diamonds') {
                    $harga = 'Rp 50.000';
                } else if ($_POST['qty'] == '2000 Diamonds') {
                    $harga = 'Rp 100.000';
                } else if ($_POST['qty'] == '4000 Diamonds') {
                    $harga = 'Rp 200.000';
                } else {
                    $harga = 'Rp 400.000';
                };
        ...
        echo "<script> 
          ...
          document.location.href = '../freefire/freefire.php';
          </script>
        ";
        };
    } else {
